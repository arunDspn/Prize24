...
class _UserGiftDto extends UserGiftDto {
  const _UserGiftDto({required this.id, required this.userId, required this.giftId, required this.giftName, required this.giftDescription, required this.isRedeemable, required this.isRedeemed, @JsonKey(defaultValue: false) this.availedViaClub, required this.availedAt, this.redeemedAt, final  List<SupportedShopDto>? supportedShops, this.payload, this.availedViaStreak, this.streakShopID, this.sourceType, this.giftLibraryId, this.bucketId, this.shopId, this.assignmentMode, this.rewardOpportunityId}): _supportedShops = supportedShops,super._();
