...
//                         // Enterprise option
//                         _buildEnterpriseCard(delayIndex: 1),
...
//               child: Text(
//                 'Subscribe to our vendor plan or contact us for enterprise solutions.',
//                 style: TextStyle(
//                   fontSize: 16,
//                   color: _PaywallColors.slate500,
//                   height: 1.5,
...
//     final limits = RevenueCatHelper.getTierLimitsForTier(VendorTier.standard);
//     switch (tier) {
...
//           maxUserFollowing: limits.maxUserFollowing,
...
//   Widget _buildEnterpriseCard({required int delayIndex}) {
//     return TweenAnimationBuilder<double>(
//       tween: Tween(begin: 0, end: 1),
//       duration: Duration(milliseconds: 600 + (delayIndex * 100)),
//       curve: const Cubic(0.16, 1, 0.3, 1),
...
//           color: Colors.white,
//           borderRadius: BorderRadius.circular(28),
//           border: Border.all(color: _PaywallColors.slate200, width: 2),
//           boxShadow: [
//             BoxShadow(
//               color: Colors.black.withOpacity(0.05),
//               blurRadius: 30,
...
//                       end: Alignment.bottomCenter,
//                       colors: [
//                         _PaywallColors.slate200.withOpacity(0.3),
//                         Colors.transparent,
//                       ],
//                     ),
//                   ),
...
//                               end: Alignment.bottomRight,
//                               colors: [
//                                 _PaywallColors.slate600,
//                                 _PaywallColors.slate900,
//                               ],
//                             ),
//                             boxShadow: [
//                               BoxShadow(
//                                 color: _PaywallColors.slate600.withOpacity(0.3),
//                                 blurRadius: 8,
//                                 offset: const Offset(0, 4),
//                               ),
//                             ],
...
//       'Hi, I\'m interested in the Enterprise plan for becoming a vendor.',
//     );
//     final whatsappUrl =
//         'https://wa.me/${RevenueCatHelper.enterpriseWhatsAppNumber}?text=$message';
